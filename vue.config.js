...
const changePages = require('./change.pages.js');
...
let copyPlugin = [
    ...
    {
        from: path.join(__dirname, 'src/siteinfo.js'),
        to: path.join(__dirname, 'dist', process.env.NODE_ENV === 'production' ? 'build' : 'dev', process.env.UNI_PLATFORM, 'plugins/weekly_buy/siteinfo.js')
    },
    {
        from: path.join(__dirname, 'src/siteinfo.js'),
        to: path.join(__dirname, 'dist', process.env.NODE_ENV === 'production' ? 'build' : 'dev', process.env.UNI_PLATFORM, 'plugins/stock/siteinfo.js')
    },
    {
        from: path.join(__dirname, 'src/siteinfo.js'),
        to: path.join(__dirname, 'dist', process.env.NODE_ENV === 'production' ? 'build' : 'dev', process.env.UNI_PLATFORM, 'plugins/region/siteinfo.js')
    },
    {
        from: path.join(__dirname, 'src/siteinfo.js'),
        to: path.join(__dirname, 'dist', process.env.NODE_ENV === 'production' ? 'build' : 'dev', process.env.UNI_PLATFORM, 'plugins/fission/siteinfo.js')
    },
    {
        from: path.join(__dirname, 'src/siteinfo.js'),
    ...
    {
        from: path.join(__dirname, 'src/siteinfo.js'),
        to: path.join(__dirname, 'dist', process.env.NODE_ENV === 'production' ? 'build' : 'dev', process.env.UNI_PLATFORM, 'plugins/diy/siteinfo.js')
    },
    {
        from: path.join(__dirname, 'src/siteinfo.js'),
    ...
    {
        from: path.join(__dirname, 'src/siteinfo.js'),
        to: path.join(__dirname, 'dist', process.env.NODE_ENV === 'production' ? 'build' : 'dev', process.env.UNI_PLATFORM, 'pages/quick-shop/siteinfo.js')
    },
    {
        from: path.join(__dirname, 'src/siteinfo.js'),
    ...
    {
        from: path.join(__dirname, 'src/pages/quick-shop/image'),
        to: path.join(__dirname, 'dist', process.env.NODE_ENV === 'production' ? 'build' : 'dev', process.env.UNI_PLATFORM, 'pages/quick-shop/image')
    },
    {
    ...
    {
        from: path.join(__dirname, 'src/plugins/book/image'),
        to: path.join(__dirname, 'dist', process.env.NODE_ENV === 'production' ? 'build' : 'dev', process.env.UNI_PLATFORM, 'plugins/book/image')
    },
    {
    ...
    {
        from: path.join(__dirname, 'src/plugins/weekly_buy/image'),
        to: path.join(__dirname, 'dist', process.env.NODE_ENV === 'production' ? 'build' : 'dev', process.env.UNI_PLATFORM, 'plugins/weekly_buy/image')
    },
    {
        from: path.join(__dirname, 'src/plugins/fission/image'),
        to: path.join(__dirname, 'dist', process.env.NODE_ENV === 'production' ? 'build' : 'dev', process.env.UNI_PLATFORM, 'plugins/fission/image')
    },
    {
        from: path.join(__dirname, 'src/plugins/diy/image'),
        to: path.join(__dirname, 'dist', process.env.NODE_ENV === 'production' ? 'build' : 'dev', process.env.UNI_PLATFORM, 'plugins/diy/image')
    },
    {
        from: path.join(__dirname, 'src/pages/order/image'),
        to: path.join(__dirname, 'dist', process.env.NODE_ENV === 'production' ? 'build' : 'dev', process.env.UNI_PLATFORM, 'pages/order/image')
    },
    {
        from: path.join(__dirname, 'src/pages/order-submit/image'),
        to: path.join(__dirname, 'dist', process.env.NODE_ENV === 'production' ? 'build' : 'dev', process.env.UNI_PLATFORM, 'pages/order-submit/image')
    },
    {
